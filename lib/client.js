  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      ctx.effect(function () {
        ...
        style.textContent =
          '#dfo-gap:focus-visible{ border-color: var(--dsw-alias-brand-primary); outline: none; }' +
          '#dfo-gap::-webkit-outer-spin-button,#dfo-gap::-webkit-inner-spin-button{ -webkit-appearance: none; margin: 0; }' +
          '#dfo-gap{ -moz-appearance: textfield; appearance: textfield; }' +
