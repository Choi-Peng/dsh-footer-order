...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var en = {
      ...
      settingsRowHint: 'The reserved id "settings" is the shell’s Settings row (the sidebar.settings slot). List it to place it anywhere among the footer entries; leave it out and it stays at the bottom.',
      moveUp: 'Move up',
      moveDown: 'Move down',
      saveLabel: 'Save',
    ...
    var zh = {
      ...
      settingsRowHint: '保留 id “settings” 代表外壳的设置行(sidebar.settings 槽位)。写进顺序表即可把它放到任意位置;不写则保持在最底部。',
      moveUp: '上移',
      moveDown: '下移',
      saveLabel: '保存',
      resetLabel: '恢复默认',
    ...
    function apply(ctx) {
      ...
      // this plugin had moved it into the footer column.
      ctx.effect(function () {
        return function () {
          try {
        ...
        return react.createElement('li', { style: cardStyle },
          ...
          open ? react.createElement('div', { style: bodyStyle },
            ...
            react.createElement('div', { style: fieldStyle },
              ...
              react.createElement('p', { style: hintStyle }, t('settingsRowHint'))
            ),
